...
<script>
  import VSelection from '../../components/baseComponents/selection'
  import VCounter from '../../components/baseComponents/counter'
  import VMulChooser from '../../components/baseComponents/multiplyChooser'
  export default {
    components: {
      VSelection,
      VCounter,
